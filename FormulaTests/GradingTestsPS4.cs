...
public class GradingTestsPS4
{
    ...
    /// <summary>
    ///   <para>
    ///     Different formulas should have different hash codes.
    ///   </para>
    ///   <para>
    ///     While it is ridiculously unlikely for two formula strings to have
    ///     the same hash code, it is possible.  Having three makes it even less likely.
    ///     If this test fails, you may have to look at the implementations.
    ///   </para>
    /// </summary>
    [TestMethod]
    [Timeout( 2000 )]
    ...
    {
        Assert.ThrowsExactly<FormulaFormatException>( ( ) => _ = new Formula( "xx" ) );
    }
